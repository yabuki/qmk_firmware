...
[BASE] = LAYOUT_ergodox(
  ...
  MO(SYMB),        MO(MDIA),  KC_LGUI,       KC_LALT, KC_MHEN,
                                                                 KC_ESC,  KC_ZKHK,
                                                                          KC_HOME,
...
[SYMB] = LAYOUT_ergodox(
  ...
  KC_TRNS, KC_UP,   KC_TRNS, KC_8,    KC_9,    KC_ASTR, KC_F12,
           KC_DOWN, KC_LEFT, KC_UP,   KC_DOWN, KC_RIGHT,KC_TRNS,
